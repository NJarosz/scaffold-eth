...
contract OldEnglish is ERC721Enumerable, Ownable {
  ...
  function renderTokenById(uint256 id) public view returns (string memory) {
    ...
    string memory fluid = string(abi.encodePacked('<path class="cls-5" d="m268.79,139.14v350.59c0,24.02-19.48,43.5-43.5,43.5H72.69c-24.03,0-43.5-19.48-43.5-43.5V139.14c0-.68.02-1.36.05-2.03.04.13.1.26.2.38,3.54,5.07,47.43,9.17,103.56,9.84,5.23.06,10.57.09,15.99.09s10.76-.03,15.99-.09c56.12-.67,99.97-4.77,103.56-9.83.1-.13.17-.26.2-.39.03.67.05,1.35.05,2.03Z"/>',
